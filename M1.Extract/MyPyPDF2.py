...
# actuellement quelques numereau de page sont dans les references
...
def visitor_body(text, cm, tm, fontDict, fontSize):
    ...
    if text.find("References") != -1: # startswith("1") :
...
def visitor_before(op, args, cm, tm):
    ...
    # print(op,'*',args)
        ...
        #     if isinstance(args[0],List):
            ...
            # hideText = True
    # opb = op
    if op == "BDC" or op == "BMC":# or op == "BMC":
        logger.error(">NO ERROR just hinding TEXT<")
        hideText = True
    # print("before :",op)
    pass
...
def MyExtractTxtFromPdfPage(page: PyPDF2.PageObject, clean = True) -> str:
    ...
    try:
        page.extract_text(orientations=0, visitor_text=visitor_body, visitor_operand_before = visitor_before,
            visitor_operand_after =visitor_after)
